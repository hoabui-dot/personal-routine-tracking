...
export default function Home() {
  ...
  const loadGoals = async () => {
    try {
      ...
      console.error('[Goals Page Error] Failed to load goals:', {
  ...
  const handleCreateGoal = async (goalData: CreateGoalRequest) => {
    try {
      ...
      console.error('[Goals Page Error] Failed to create goal:', {
        goalData,
        error: error instanceof Error ? {
          message: error.message,
          stack: error.stack,
  ...
  const handleUpdateGoal = async (id: number, goalData: UpdateGoalRequest) => {
    try {
      ...
      console.error('[Goals Page Error] Failed to update goal:', {
        goalId: id,
        goalData,
        error: error instanceof Error ? {
          message: error.message,
