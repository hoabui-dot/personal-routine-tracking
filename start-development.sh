...
echo "   CREATE USER superuser WITH PASSWORD 'superuser';"
echo "   GRANT ALL PRIVILEGES ON DATABASE personal_tracker TO superuser;"
echo "   \\q"
echo ""
echo "4. Run the database schema:"
echo "   psql -U superuser -d personal_tracker -f api-service/sql/01_init.sql"
echo ""
